...
from projects.objectnav_baselines.experiments.clip.zeroshot_mixins import OpenworldClipResNetPreprocessGRUActorCriticMixin
...
class OW_EmbCLIP_ObjectNavProcThorPPOExperimentConfig(ObjectNavBaseConfig):
    ...
    def __init__(self, add_prev_actions: bool = False, **kwargs):
        ...
        self.preprocessing_and_model = OpenworldClipResNetPreprocessGRUActorCriticMixin(
    ...
    @classmethod
    def tag(cls):
        return "OW-ObjectNav-ProcTHOR-RGB-ClipResNet50GRU-DDPPO"
